                        ...
                        <div class="col-6"  style="margin-top:20px;">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="projeto" id="projeto">
                                    <option value="PB_R_1" selected="selected">Residencial Baixo [R1-B]</option>
                                    <option value="PB_PP_4">Residencial Baixo [PP-4-B]</option>
                                    <option value="PB_R_8">Residencial Baixo [R8-B]</option>
                                    <option value="PB_PIS">Residencial Baixo [PIS]</option>
                                    <option value="PN_R_1">Residencial Normal [R1-N]</option>
                                    <option value="PN_PP_4">Residencial Normal [PP-4-N]</option>
                                    <option value="PN_R_8">Residencial Normal [R8-N]</option>
                                    <option value="PN_R_16">Residencial Normal [R16-N]</option>
                                    <option value="PA_R_1">Residencial Alto [R1-A]</option>
                                    <option value="PA_R_8">Residencial Alto [R8-A]</option>
                                    <option value="PA_R_16">Residencial Alto [R16-A]</option>
                                    <option value="PN_CAL_8">Comercial Normal [CAL-8-N]</option>
                                    <option value="PN_CSL_8">Comercial Normal [CSL-8-N]</option>
                                    <option value="PN_CSL_16">Comercial Normal [CSL-16-N]</option>
                                    <option value="PA_CAL_8">Comercial Alto [CAL-8-A]</option>
                                    <option value="PA_CSL_8">Comercial Alto [CSL-8-A]</option>
                                    <option value="PA_CSL_16">Comercial Alto [CSL-16-A]</option>
                                    <option value="RP1Q">Residência Popular [RP1Q]</option>
                                    <option value="GI">Galpão Industrial [GI]</option>
                                </select>
                            </div>
