<html>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6" style="margin-top:20px;">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="projeto" id="projeto" onchange="selecionado()">
    ...
    <script>
        ...
        function selecionado() {
            var condicao = document.getElementById('quantidadePavimentos');
            var condicaoLabel = document.getElementById('labelQuantidade');
            if (condicao != null) {
                condicaoLabel.remove();
                condicao.remove();
            }
            ...
            label.innerHTML = "Selecione a quantidade de Pavimentos Tipo:  ";
            label.id = "labelQuantidade";
            var selectPai = document.getElementById("selectPai");
            var selectList = document.createElement("select");
            selectList.id = "quantidadePavimentos";
            selectList.name = "quantidadePavimentos";
            if (value == 'RB_PIS' || value == 'RN_PP_4')
            {
                for (var i = 1; i < 5; i++) {
                ...
                selectPai.appendChild(label);
                selectPai.appendChild(selectList);
                document.getElementById('quantidadePavimentos').className += ' form-control';

            } else if (value == 'RB_PP_4')
            {
                for (var i = 1; i < 4; i++) {
                    var option = document.createElement("option");
                    option.value = i;
            ...
            } else if (value == 'RN_R_8' || value == 'RA_R_8' || value == 'CN_CAL_8' || value == 'CN_CSL_8' || value == 'CA_CAL_8' || value == 'CA_CSL_8')
            {
                for (var i = 1; i < 9; i++) {
                    var option = document.createElement("option");
                    option.value = i;
            ...
            } else if (value == 'RN_R_16' || value == 'RA_R_16' || value == 'CN_CSL_16' || value == 'CA_CSL_16')
            {
                for (var i = 1; i < 17; i++) {
                    var option = document.createElement("option");
                    option.value = i;
